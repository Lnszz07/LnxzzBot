// Script by Zans
// 𝗭𝗮𝗻𝘀 𝗕𝗼𝘁
// ©Zans Bot Incorporated
// Abdul Ganteng:v
// Lnxzz々
//credit to Sibu and Xeon
const {
...
zeksApikey = "ZansLordd",
nomorowner1 = "@6289656093383"; 
...
const checkRegisteredUser = (sender) => {
   ...
   const isRegister = register.includes(sender)
    ...
    const totalhit = JSON.parse(fs.readFileSync("./lib/totalcmd.json"))[0]
      .totalcmd;
const daftar1 = `Hi ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Bot, Verifikasi Terlebih Dahulu`
       const daftar2 = 'Klik Tombol Verify Dulu Bro, Atau Ketik 8473\nLnxzz Bot'
       const daftar3 = [
          {
            buttonId: `verify`,
            buttonText: {
...
cmhit.push(command)
    ...
    mess = {
      ...
      error: {
        ...
        apiz: "Error!!, Mungkin Karena Apikey Nya Habis",
        Iv: "Link Tidak Valid",
      },
      only: {
        group: "Hanya Bisa Di Chat Grub",
      },
    };
...
/*const reply = (teks) => {
			Sibu.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6285869074622?text=hello`}}})
		}*/
...
// Fake Reply Bang:)
    const ftroli = {
      key: {
        ...
        remoteJid: "6289656093383-1604595598@g.us",
      },
      message: {
        orderMessage: {
          itemCount: 10,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6289656093383-1616169743@g.us",
    ...
    const fvn = {
      key: {
        ...
        ...(from ? { remoteJid: "6289656093383-1613049930@g.us" } : {}),
      },
      message: {
        audioMessage: {
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "6289656093383-1613049930@g.us",
      "fromMe": false,
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "Lnxzz々", //Kasih namalu
            description: "OHH",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "Lnxzz Bot",
            productImageCount: 1,
          },
...
Sibu.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      Sibu.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = Sibu.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Sibu Bot Inc.`, "footerText": "*_𝗭𝗮𝗻𝘀 𝗕𝗼𝘁_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝗭𝗮𝗻𝘀 𝗕𝗼𝘁`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
...
const fakewa = (teks) => {        
Sibu.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Sibu`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6285869074622?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nLnxzz Bot. (@lanszz01) •Instagram Foto Dan Video`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6289656093383`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6289656093383`,
                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6289656093383`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6285869074622@s.whatsapp.net";
        if (fil.includes(id_vote)) {
          ...
          let _vote =
            ...
            `\n\n*Alasan*: ${_votes[0].reason}\n*Nomer Votesnya* : ${vote.length} Vote\n*Durasi* : ${_votes[0].durasi} Menit\n\n`;
        ...
        let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`));
        let fil = vote.map((v) => v.participant);
        let id_vote = sender ? sender : "6289656093383@s.whatsapp.net";
        if (fil.includes(id_vote)) {
          return mentions(
            "@" + sender.split("@")[0] + " Anda Telah Memilih",
            fil,
            true
          );
        } else {
    ...
    if (isGroup && isAntilink && !mek.key.fromMe) {
      if (budy.includes("://chat.whatsapp.com/")) {
        ...
        reply("ANTILINK DETECTED!! MAAF KAMU AKAN DIKICK");
        Sibu.groupRemove(from, [sender]);
      }
    }
    if (isGroup && isAntiviewonce && m.mtype == "viewOnceMessage") {
      reply(
        `@${sender.split("@")[0]} Terdeteksi Mengirim Foto/Video Sekali Lihat!`
      );
      var msg = { ...mek };
...
if (isRegistered) return reply('Akunmu Sudah Terverifikasi')
...
*Terima Kasih Telah Mendaftar Ke Lnxzz Bot Database*
...
*「 𝗭𝗮𝗻𝘀 𝗕𝗼𝘁 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered 𝗭𝗮𝗻𝘀 𝗕𝗼𝘁*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hi ${pushname} 👋\n\nJika Kamu Memakai Wa Mod/GB Ketik #allmenu`
...
groups = Sibu.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6289656093383@s.whatsapp.net"
        dtod = '6289656093383'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
𝗡𝗼𝘁𝗲 : Bot Ini Masih Tahap Pembuatan, Jadi Kalau Ada Fitur Yang Error Laporkan Ke Owner
 
GWEJ BUKAN PROGAMMER HANDAL :v
`
...
case 'bugreport':
              ...
              teks = args.join(' ')
              reply('Terima Kasih Telah Melaporkan Bug Bot Ini Ke Owner')
              Sibu.sendMessage('6289656093383@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
kodi = `*_KLIK NEXT UNTUK SELANJUTNYA_*`
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       reply('No Sis')
        sendButMessage(from, `Hi ${pushname} 😎`, `Apa Yang Kamu Mau Jawab??`, [
          {
            buttonId: `oklah`,
            buttonText: {
              displayText: `WHY:)`,
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               ...
               await sleep(1000)
               haibg =`Hi ${pushname}\nItu Owner Gwej, Apa Yang Kamu Mau??`
...
break
case 'okvirtex':
if (!isOwner && !mek.key.fromMe) return reply('Hanya Owner Yang Bisa Menggunakan Fitur Ini')
...
Sibu.sendMessage(from,'Ini Kontak Owner Gwej',text,{quoted: mek})
break
case 'command':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
 listMsg = {
 buttonText: '𝗟𝗜𝗦𝗧 𝗠𝗘𝗡𝗨',
 footerText: 'Lnxzz Bot',
 description: `Hi @${sender.split('@')[0]}, Tolong Pilih Menu Disini`,
 sections: [
                     {
                      "title": `Lnxzz々`,
 rows: [
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `Lnxzz Bot`, [
          {
            buttonId: `command`,
            buttonText: {
              displayText: `々BACK TO MENU`,
            },
            type: 1,
          },]);
break
...
case 'script':
		case 'sc':
		case 'sourcecode':
		Sibu.sendMessage(from, { text: "https://github.com/ZansLord/ZansBot", matchedText: 'nopee', description: "", title: "Apa Yang Kamu Lakukan?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
        if (isQuotedSticker) {
          if (!q)
            return reply(`Usage : ${command} Cmd Dan Tag Stikernya`);
          var kodenya =
...
case 'unbanchat':
if (!itsMe && !isOwner)return reply('Hanya Owner Yang Bisa Menggunakan Fitur Ini')
...
const bMess = {
    ...
    footerText: 'Tolong Pilih Salah Satu',
    buttons: buttonss,
    headerType: 1
}
     ...
     break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply('Hanya Owner Yang Bisa Menggunakan Fitur Ini')    
					...
					buff = await Sibu.downloadMediaMessage(encmedia)
					for (let _ of anu) {
						Sibu.sendMessage(_.jid, buff, image, {quoted:fakestatus ,caption: `「  *Lnxzz Bot BROADCAST* 」\n\n${ini_bc}`})
					}
					reply('```Success Broadcast```')
					} else {
					for (let _ of anu) {
					Sibu.sendMessage(_.jid, `*Lnxzz Bot BROADCAST*\n${ini_bc}`, text, { contextInfo: { mentionedJid: [sender],"forwardingScore":999,"isForwarded":true},sendEphemeral: true })
					}
					reply('```Success Broadcast```')
					}
					break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
      ...
      case "antilink":
        ...
        if (args[0] == "on") {
          ...
          sendButMessage(from, `MODE ANTILINK`, `Tolong Pilih Salah Satu`, [
            {
...
break
      case "autojoin":
        ...
        if (args[0] == "on") {
          ...
          sendButMessage(from, `MODE AUTOJOIN`, `Tolong Pilih Salah Satu`, [
            {
      ...
      case "antivirtex":
        ...
        if (args[0] == "on") {
          ...
          sendButMessage(from, `MODE ANTIVIRTEX`, `Tolong Pilih Salah Satu`, [
            {
      ...
      case "kickarea":
        ...
        if (args[0] == "on") {
          ...
          sendButMessage(from, `MODE KICKAREA`, `Tolong Pilih Salah Satu`, [
            {
...
break
                 ...
                 break
			      case "mode":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `MODE SELF/PUBLIC`, `Tolong Pilih Salah Satu`, [
          {
            buttonId: `self`,
            buttonText: {
...
case "intake3": // by Sibu
      ...
      case "grup":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `GROUP SETTING`, `Tolong Pilih Salah Satu`, [
          {
            buttonId: `opengc`,
            buttonText: {
              displayText: `OPEN`,
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'Lnxzz Bot', imageMessage: imageMsg,
		...
		case 'write':
                ...
                dpuhy = args.join(' ')
               tiyo = `Tolong Pilih Salah Satu`
sendButMessage(from, tiyo, `Lnxzz Bot`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             Sibu.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 Lnxzz Bot BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
//Done
case 'writeleft':
if (!c) return reply('Textnya Mana Bro??')
reply(mess.wait)
...
*[Wait] Wait a moment..*`
      ...
      case "s":
        ...
        break;
      case "toimg":
        if (!isQuotedSticker) return reply("𝗥𝗲𝗽𝗹𝘆/𝘁𝗮𝗴 𝘀??𝗶𝗰??𝗲𝗿 !");
        reply(mess.wait);
        encmedia = JSON.parse(JSON.stringify(mek).replace("quotedM", "m"))
          .message.extendedTextMessage.contextInfo;
        media = await Sibu.downloadAndSaveMediaMessage(encmedia);
